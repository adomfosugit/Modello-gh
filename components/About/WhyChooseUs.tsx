...
const WhyChooseUs = () => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 mb-4">
      <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 md:p-12   transition-shadow duration-300">
        {/* Title */}
        ...
        <a 
          href="/About"
          className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-primary/70 transition-colors duration-300 group"
        >
          Read More About Us
